...
{
    [Serializable]
    public class ChessComGeneticAlgorithm
    {
        //
        ...
        //Constructor.
        public ChessComGeneticAlgorithm(bool MovementsAStarGreedyHeuristicTFou, bool IgnoreSelfObject, bool UsePenaltyRegardMechnisa, bool BestMovment, bool PredictHurist, bool OnlySel, bool AStarGreedyHuris, bool Arrangments)
        {
                ...
                for (Gen1 = 0; Gen1 < 8; Gen1++)
                    for (Gen2 = 0; Gen2 < 8; Gen2++)
                    {
                        ...
                        Gen2, color, GeneticTable[CromosomRow, CromosomColumn]))
                        {
                            ...
                            if (ThinkingChessCom.ExistTableInList(CloneATable(GeneticTable), List, 0))
                            {
