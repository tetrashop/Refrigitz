...
#pragma warning restore CS0168 // The variable 't' is declared but never used
        ...
        //Initiate of Rules of ChessCom Refregitz.
            ...
            lock (O)
            {
                ...
                {             //Gray Order.
                    if (Order == 1)
                    {
                        ...
                        if (ChessCom.ChessRules.CastleKingAllowedGray)
                        {
                    ...
                    else//Order of Brown.
                    {
                        ...
                        if (ChessCom.ChessRules.CastleKingAllowedBrown)
                        {
                            //Column Situation.
        ...
        public bool ObjectDangourKingMove(int Order, int[,] Table, bool DoIgnore)
        {
            ...
            {     //long Time = TimeElapced.TimeNow();Spaces++;
                ...
                ///{
                /// if (DoIgnore)
                ///ChessCom.ChessRules.CheckObjectDangourIgnoreSelfThingBetweenTowEnemyKing = true;
                // }
                ...
                int CDummy = ChessCom.ChessRules.CurrentOrder;
                int COrder = Order;
                if (Order == 1)
                {
                            ...
                            for (var jj = 0; jj < 8; jj++)
                            {
                                ...
                                for (var iii = 0; iii < 8; iii++)
                                {
                                    for (var jjj = 0; jjj < 8; jjj++)
                                    {
                                        ...
                                        if (Tab[iii, jjj] < 0)
                                            continue;
                                        ChessCom.ThinkingChessCom AA = new ChessCom.ThinkingChessCom(-1, 0, CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsBoard, ii, jj);
                                        ...
                                        if (AA.Attack(CloneATable(Tab), ii, jj, iii, jjj, Color.Brown, Order * -1))
                                        {
                                            ...
                                            for (int h = 0; h < 8; h++)
                                                for (int g = 0; g < 8; g++)
                                                    Tabl[h, g] = Tab[h, g];
                                            ChessCom.ChessRules AAA = new ChessCom.ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsBoard, Tabl[iii, jjj], CloneATable(Tabl), Order, iii, jjj);
                ...
                //lock (O1)
                //{
                //ChessCom.ChessRules.CheckObjectDangourIgnoreSelfThingBetweenTowEnemyKing = false;
                //}
                ...
                if (CheckBrownObjectDangour || CheckGrayObjectDangour)
                {
                    ...
                    ChessCom.ChessRules.CurrentOrder = CDummy;
                    Order = COrder;
        ...
        public bool ObjectDangourKingMove(int Order, int[,] Table, bool DoIgnore, int ii, int jj)
        {
            ...
            { //long Time = TimeElapced.TimeNow();Spaces++;
...

                {
                    ...
                    ChessCom.ChessRules.CurrentOrder = -1;
                    Order = -1;
                    //For Enemies.
                    for (var i = 0; i < 8; i++)
                    {
                        for (var j = 0; j < 8; j++)
                        {
                            ...
                            for (var iii = 0; iii < 8; iii++)
                            {
                                for (var jjj = 0; jjj < 8; jjj++)
                                {
                                    ...
                                    ChessCom.ChessRules A = new ChessCom.ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsBoard, Tab[i, j], CloneATable(Tab), Order * -1, i, j);
                                    Color a = Color.Gray;
                                    if (Order * -1 == -1)
                                        a = Color.Brown;
                                                    ...
                                                    for (var jjjj = 0; jjjj < 8; jjjj++)
                                                    {
                                                        ...
                                                        for (int iiiii = 0; iiiii < 8; iiiii++)
                                                        {
                                                            for (int jjjjj = 0; jjjjj < 8; jjjjj++)
                                                            {
                                                                ...
                                                                A = new ChessCom.ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsBoard, Tab[iiii, jjjj], CloneATable(Tab), Order, iiii, jjjj);
            ...
            )
        {
            ...
            lock (OOO)
            {
                ...
                ChessCom.ChessRules A = new ChessCom.ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, Arrange, 1, CloneATable(Tab), 1, Row, Column);
                ChessCom.ChessRules AA = new ChessCom.ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, Arrange, 1, CloneATable(Tab), 1, Row, Column);
                ChessCom.ChessRules AAA = new ChessCom.ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, Arrange, 1, CloneATable(Tab), 1, Row, Column);
                ...
                if (A.CheckGray)
                {
                    ...
                    lock (O2)
                    {
                        ChessCom.ChessRules.CastleKingAllowedGray = false;
                        ChessCom.ChessRules.CastleActGray = true;
                        ChessCom.ThinkingChessCom.KingMaovableGray = true;
                    }
                }
                else if (A.CheckBrown)
                {
                    ...
                    lock (O2)
                    {
                        ChessCom.ChessRules.CastleActBrown = true;
                        ChessCom.ChessRules.CastleKingAllowedBrown = false;
                        ChessCom.ThinkingChessCom.KingMaovableBrown = true;
                    }
                }
                bool Castles = false;
                if (Order == 1)
                    if (ChessCom.ChessRules.SmallKingCastleGray || ChessCom.ChessRules.BigKingCastleGray)
                        Castles = true;
                if (Order == -1)
                    if (ChessCom.ChessRules.SmallKingCastleBrown || ChessCom.ChessRules.BigKingCastleBrown)
                        Castles = true;
                ...
                if (SodierConvert || (CastleKing && Castles))
                {
                    ...
                    {
                        //Castles Brown King.
                        if (ChessCom.ChessRules.SmallKingCastleGray)
                        {
                            Object O2 = new Object();
                            lock (O2)
                            {
                                ...
                                lock (O)
                                {
                                    ...
                                    {
                                        ChessCom.ChessRules.SmallKingCastleGray = false;
                                        ChessCom.ChessRules.CastleKingAllowedGray = false;
                                    }
                                }
                            }
                            ...
                            if (ChessCom.ChessRules.BigKingCastleGray)
                        //Castles Brown King.                    
                        {
                            Object O2 = new Object();
                            lock (O2)
                            {
                                ...
                                lock (O)
                                {
                                    if (!AllDraw.Stockfish)
                                    {
                                        ChessCom.ChessRules.BigKingCastleGray = false;
                                        ChessCom.ChessRules.CastleKingAllowedGray = false;
                                    }
                                }
                            }
                                ...
                                if (ChessCom.ChessRules.SmallKingCastleBrown)
                        //Castles Brown King.                    
                        {
                            Object O2 = new Object();
                            lock (O2)
                            {
                                ...
                                lock (O)
                                {
                                    if (!AllDraw.Stockfish)
                                    {
                                        ChessCom.ChessRules.SmallKingCastleBrown = false;
                                        ChessCom.ChessRules.CastleKingAllowedBrown = false;
                                    }
                                }
                            }
                                    ...
                                    if (ChessCom.ChessRules.BigKingCastleBrown)
                        //Castles Brown King.                    
                        {
                            ...
                            lock (O2)
                            {
                                ...
                                lock (O)
                                {
                                    if (!AllDraw.Stockfish)
                                    {
                                        ChessCom.ChessRules.BigKingCastleBrown = false;
                                        ChessCom.ChessRules.CastleKingAllowedBrown = false;
                                    }
                                }
                            }
                            ...
                            else//else of Condition.
                            {
                                ...
                                for (var ii = 0; ii < 8; ii++)
                                    for (var jj = 0; jj < 8; jj++)
                                    {
                                        ...
                                        if ((new ChessCom.ThinkingChessCom(-1, 0, CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsBoard, i, j)).Movable(CloneATable(Table), i, j, ii, jj, A, Order))
                                        {
                                ...
                                for (var jj = 0; jj < 8; jj++)
                                {
                                    ...
                                    if (Table[i, j] < 0)
                                    {
                                        ...
                                        if (Table[ii, jj] > 0)
                                        {
                                            ...
                                            //If Is Movable.
                                            if ((new ChessCom.ThinkingChessCom(-1, 0, CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsBoard, i, j)).Movable(CloneATable(Tab), i, j, ii, jj, Color.Brown, -1))
                                            {
                                                //Clone a Copy.
                                                for (var iii = 0; iii < 8; iii++)
                                                    for (var jjj = 0; jjj < 8; jjj++)
                                ...
                                for (var jj = 0; jj < 8; jj++)
                                {
                                    ...
                                    if (Table[i, j] > 0)
                                    {
                                        ...
                                        if (Table[ii, jj] < 0)
                                        {
                                            ...
                                            if ((new ChessCom.ThinkingChessCom(-1, 0, CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsBoard, i, j)).Movable(CloneATable(Tab), i, j, ii, jj, Color.Gray, 1))
                                            {
                                                for (var iii = 0; iii < 8; iii++)
                                                    for (var jjj = 0; jjj < 8; jjj++)
                                                    {
            ...
            {   //long Time = TimeElapced.TimeNow();Spaces++;
                ...
                for (var i = 0; i < 8; i++)
                    for (var j = 0; j < 8; j++)
                    {
                        ...
                        if ((new ChessCom.ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsBoard, Table[ii, jj], CloneATable(Table), Order, ii, jj)).Rules(ii, jj, i, j, a, Table[ii, jj]))
                        {
                            Tab[i, j] = true;
                        }
                        if ((new ChessCom.ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsBoard, Table[ii, jj], CloneATable(Table), Order, ii, jj)).Rules(ii, jj, i, j, a, Table[ii, jj]))
                ...
                for (var i = 0; i < 8; i++)
                {
                    for (var j = 0; j < 8; j++)
                    {
                        ...
                        if (Ord == -1 & Tab[i, j] >= 0)
                            continue;
                        //Initiate Global Variables.
                        int Dummt = ChessCom.ChessRules.CurrentOrder;
                        ChessCom.ChessRules.CurrentOrder = -1;
                        //Clone a Copy.
                        for (var ii = 0; ii < 8; ii++)
                            for (var jj = 0; jj < 8; jj++)
                        ...
                        if (Ord == -1)
                            a = Color.Brown;
                        ChessCom.ChessRules A = new ChessCom.ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsBoard, Table[i, j], CloneATable(Table), Ord, i, j);
                        if (Ord == 1)
                        {
                        ...
                        //Initiate Global Variables.
                        ChessCom.ChessRules.CurrentOrder = Dummt;
        ...
        public bool Check(int[,] Table, int Ord)
        {
            ...
            {  //long Time = TimeElapced.TimeNow();Spaces++;
               //A player is not required to move their king out of check and the game concludes when there is a 100 % probability that one of the kings has been taken. As a result there is no checkmate.
                ...
                bool Store = ChessCom.ChessRules.CheckObjectDangourIgnoreSelfThingBetweenTowEnemyKing;
                Object OO = new Object();
                lock (OO)
                {
                    ChessCom.ChessRules.CheckObjectDangourIgnoreSelfThingBetweenTowEnemyKing = false;
                ...
                for (var i = 0; i < 8; i++)
                {
                    for (var j = 0; j < 8; j++)
                    {
                        ...
                        if (Checked)
                        {
                            ...
                            if (Ord == -1)
                                a = Color.Brown;
                            ChessCom.ChessRules A = new ChessCom.ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsBoard, Table[RowK, ColumnK], CloneATable(Table), Ord, RowK, ColumnK);
                            Order = DummyOrder;
                            ///Table[ii, jj] = 0;
                            //Menen Parameter is Moveble to Second Parameters Location returm Movable.
                            for (int k = 0; k < 8; k++)
                        ...
                        for (var ii = 0; ii < 8; ii++)
                        {
                            ...
                            for (var jj = 0; jj < 8; jj++)
                            {
                                ...
                                if (A.Rules(i, j, ii, jj, a, Ord))
                                {
                                    ...
                                    Table[i, j] = 0;
                                    //If Check.
                                    A = new ChessCom.ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsBoard, Table[ii, jj], CloneATable(Table), Ord, ii, jj);
                                    if (A.Check(CloneATable(Table), Ord))
                                    {
                                        Order = DummyOrder;
                                        //Move Back.
        ...
        public bool CheckMate(int[,] Tab, int Ord)
        {
            ...
            {     //long Time = TimeElapced.TimeNow();Spaces++;
                ...
                for (var i = 0; i < 8; i++)
                    for (var j = 0; j < 8; j++)
                        Table[i, j] = Tab[i, j];
                ChessCom.ChessRules A = new ChessCom.ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsBoard, Table[RowG, ColumnG], CloneATable(Table), Ord, RowG, ColumnG);
                ...
                ChessCom.ChessRules AA = new ChessCom.ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsBoard, Table[RowB, ColumnB], CloneATable(Table), Ord, RowB, ColumnB);
        ...
        //Internal Rule of ChessCom Method.
