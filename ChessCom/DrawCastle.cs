...
namespace ChessCom
{
    ...
    public class DrawCastle
    {
        ...
        public Color color;
        public ThinkingChessCom[] CastleThinking = new ThinkingChessCom[AllDraw.CastleMovments];
            ...
            )
        {
            ...
            lock (balancelock)
            {
                ...
                for (var ii = 0; ii < AllDraw.CastleMovments; ii++)
                    CastleThinking[ii] = new ThinkingChessCom(ii, 4, CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsChanged, (int)i, (int)j, a, CloneATable(Tab), 16, Ord, TB, Cur, 4, 4);
            ...
            )
        {
            ...
            for (var i = 0; i < AllDraw.CastleMovments; i++)
            {
                ...
                AA.CastleThinking[i] = new ThinkingChessCom(i, 4, CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsChanged, (int)this.Row, (int)this.Column);
