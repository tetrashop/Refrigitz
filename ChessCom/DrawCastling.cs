...
namespace ChessCom
{
    ...
    public class DrawCastling
    {
        ...
        public ThinkingChessCom[] CastlingThinking = new ThinkingChessCom[1];
            ...
            )
        {
            ...
            lock (balancelock)
            {
                ...
                {
                    for (var ii = 0; ii < 1; ii++)
                        CastlingThinking[ii] = new ThinkingChessCom(ii, 7, CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsChanged, (int)i, (int)j, a, CloneATable(Tab), 1, Ord, TB, Cur, 1, 7);
                }
                else
                {
                    for (var ii = 0; ii < 1; ii++)
            ...
            )
        {
            ...
            for (var i = 0; i < AllDraw.KingMovments; i++)
            {
                ...
                AA.CastlingThinking[i] = new ThinkingChessCom(i, 6, CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsChanged, (int)this.Row, (int)this.Column);
