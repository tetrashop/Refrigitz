...
namespace ChessCom
{
...

    {
        ...
        public ThinkingChessCom[] ElefantThinking = new ThinkingChessCom[AllDraw.ElefantMovments];
            ...
            )
        {
            ...
            lock (balancelock)
            {
                ...
                for (var ii = 0; ii < AllDraw.ElefantMovments; ii++)
                    ElefantThinking[ii] = new ThinkingChessCom(ii,2,CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsChanged, (int)i, (int)j, a, CloneATable(Tab), 16, Ord, TB, Cur, 4, 2);
            ...
            )
        {
            ...
            for (var i = 0; i < AllDraw.ElefantMovments; i++)
            {
                ...
                AA.ElefantThinking[i] = new ThinkingChessCom(i,2,CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsChanged, (int)this.Row, (int)this.Column);
