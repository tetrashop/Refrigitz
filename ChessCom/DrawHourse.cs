...
namespace ChessCom
{
    ...
    public class DrawHourse
    {
        ...
        public ThinkingChessCom[] HourseThinking = new ThinkingChessCom[AllDraw.HourseMovments];
            ...
            )
        {
...

            {
                ...
                for (var ii = 0; ii < AllDraw.HourseMovments; ii++)
                    HourseThinking[ii] = new ThinkingChessCom(ii,3,CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsChanged, (int)i, (int)j, a, CloneATable(Tab), 8, Ord, TB, Cur, 4, 3);
            ...
            )
        {
            ...
            for (var i = 0; i < AllDraw.HourseMovments; i++)
            {
                ...
                AA.HourseThinking[i] = new ThinkingChessCom(i,3,CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsChanged, (int)this.Row, (int)this.Column);
