...
namespace ChessCom
{
    ...
    public class DrawKing
    {
        ...
        public ThinkingChessCom[] KingThinking = new ThinkingChessCom[AllDraw.KingMovments];
            ...
            )
        {
            ...
            lock (balancelock)
            {
                ...
                for (var ii = 0; ii < AllDraw.KingMovments; ii++)
                    KingThinking[ii] = new ThinkingChessCom(ii, 6, CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsChanged, (int)i, (int)j, a, CloneATable(Tab), 8, Ord, TB, Cur, 2, 6);
            ...
            )
        {
            ...
            for (var i = 0; i < AllDraw.KingMovments; i++)
            {
                ...
                AA.KingThinking[i] = new ThinkingChessCom(i, 6, CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsChanged, (int)this.Row, (int)this.Column);
