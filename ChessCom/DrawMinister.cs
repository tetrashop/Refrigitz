...
namespace ChessCom
{
    ...
    public class DrawMinister//:DrawKing
    {
        ...
        public int Order;
        public ThinkingChessCom[] MinisterThinking = new ThinkingChessCom[AllDraw.MinisterMovments];
            ...
            )
        {
            ...
            lock (balancelock)
            {
                ...
                for (var ii = 0; ii < AllDraw.MinisterMovments; ii++)
                    MinisterThinking[ii] = new ThinkingChessCom(ii,5,CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsChanged, (int)i, (int)j, a, CloneATable(Tab), 32, Ord, TB, Cur, 2, 5);
            ...
            )
        {
            ...
            for (var i = 0; i < AllDraw.MinisterMovments; i++)
            {
                ...
                AA.MinisterThinking[i] = new ThinkingChessCom(i,5,CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsChanged, (int)this.Row, (int)this.Column);
