...
namespace ChessCom
{
    ...
    public class DrawSoldier : ThingsConverter
    {
        ...
        public Color color;
        public ThinkingChessCom[] SoldierThinking = new ThinkingChessCom[AllDraw.SodierMovments];
            ...
            base(Arrangments, (int)i, (int)j, a, Tab, Ord, TB, Cur)
        {
            ...
            lock (balancelock)
            {
                ...
                for (var ii = 0; ii < AllDraw.SodierMovments; ii++)
                    ...
                    SoldierThinking[ii] = new ThinkingChessCom(ii,1,CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsChanged, (int)i, (int)j, a, CloneATable(Tab), 4, Ord, TB, Cur, 16, 1);
                Row = i;
                Column = j;
                color = a;
                Order = Ord;
            ...
            )
        {
            ...
            for (var i = 0; i < AllDraw.SodierMovments; i++)
            {
                ...
                AA.SoldierThinking[i] = new ThinkingChessCom(i,1,CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsChanged, (int)this.Row, (int)this.Column);
