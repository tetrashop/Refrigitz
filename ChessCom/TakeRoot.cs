...
namespace ChessCom
{
    ...
    public class TakeRoot
    {
        ...
        static void Log(Exception ex)
        {
            try
            {
                ...
                lock (a)
                {
                    ...
                    File.AppendAllText(ChessComForm.Root + "\\ErrorProgramRun.txt", stackTrace + ": On" + DateTime.Now.ToString()); // path of file where stack trace will be stored.
                }
            }
        ...
        public bool LoadJungle(String path,bool FOUND, bool Quantum, ChessComForm Curent, ref bool LoadTree, bool MovementsAStarGreedyHeuristicFound, bool IInoreSelfObjects, bool UsePenaltyRegardMechnisam, bool BestMovments, bool PredictHeuristic, bool OnlySelf, bool AStarGreedyHeuristic, bool ArrangmentsChanged)
        {
            Object OO = new Object();
            lock (OO)
            {
                ...
                try
                {
                    ChessComForm.AllDrawKindString = path;

                    if (File.Exists(ChessComForm.AllDrawKindString))
                    {
                        if (ChessComForm.MovmentsNumber >= 0)
                        {
                            //if (!Quantum)
                            {
                                ...
                                t = (AllDraw)tr.LoadJungle(path, Quantum, ChessComForm.OrderPlate);
                                if (t != null)
                                {
                                    Curent.Draw = t;
                            ...
                            {
                                RefregizMemmory tr = new RefregizMemmory(MovementsAStarGreedyHeuristicFound, IInoreSelfObjects, UsePenaltyRegardMechnisam, BestMovments, PredictHeuristic, OnlySelf, AStarGreedyHeuristic, ArrangmentsChanged);
                               tt =(QuantumRefrigiz.AllDraw) tr.LoadQ(Quantum, ChessComForm.OrderPlate);
                                if (t != null)
                                {
                        ...
                        File.Delete(ChessComForm.AllDrawKindString);
                    }
                }
                catch (Exception t) { Log(t); }
        ...
        public bool Load(bool FOUND, bool Quantum, ChessComForm Curent, ref bool LoadTree, bool MovementsAStarGreedyHeuristicFound, bool IInoreSelfObjects, bool UsePenaltyRegardMechnisam, bool BestMovments, bool PredictHeuristic, bool OnlySelf, bool AStarGreedyHeuristic, bool ArrangmentsChanged)
        {
            Object OO = new Object();
            lock (OO)
            {
                ...
                try
                {
                    if (File.Exists(ChessComForm.AllDrawKindString))
                    {
                        if (ChessComForm.MovmentsNumber >= 0)
                        {
                            //if (!Quantum)
                            {   RefregizMemmory tr = new RefregizMemmory(MovementsAStarGreedyHeuristicFound, IInoreSelfObjects, UsePenaltyRegardMechnisam, BestMovments, PredictHeuristic, OnlySelf, AStarGreedyHeuristic, ArrangmentsChanged);
                                t = (AllDraw)tr.Load(Quantum, ChessComForm.OrderPlate);
                                if (t != null)
                                {
                                    Curent.Draw = t;
        ...
        public bool Save(bool FOUND,bool Quantum, ChessComForm Curent, ref bool LoadTree, bool MovementsAStarGreedyHeuristicFound, bool IInoreSelfObjects, bool UsePenaltyRegardMechnisam, bool BestMovments, bool PredictHeuristic, bool OnlySelf, bool AStarGreedyHeuristic, bool ArrangmentsChanged)
        {
            Object OO = new Object();
            lock (OO)
            {
                    ...
                    {    RefregizMemmory rt = new RefregizMemmory(MovementsAStarGreedyHeuristicFound, IInoreSelfObjects, UsePenaltyRegardMechnisam, BestMovments, PredictHeuristic, OnlySelf, AStarGreedyHeuristic, ArrangmentsChanged
                        ...
                        //if (!Quantum)
                        {
                            if (Curent.Draw != null)
                            {
                                ...
                                rt.RewriteAllDraw(ChessComForm.OrderPlate);
                        ...
                        /*else {
                            if (Curent.DrawQ != null)
                            {
                                ...
                                rt.RewriteAllDrawQ(ChessComForm.OrderPlate);
...
#pragma warning restore CS0162 // Unreachable code detected
        ...
        public bool SaveJungle(bool FOUND, bool Quantum, ChessComForm Curent, ref bool LoadTree, bool MovementsAStarGreedyHeuristicFound, bool IInoreSelfObjects, bool UsePenaltyRegardMechnisam, bool BestMovments, bool PredictHeuristic, bool OnlySelf, bool AStarGreedyHeuristic, bool ArrangmentsChanged)
        {
            Object OO = new Object();
            lock (OO)
            {
