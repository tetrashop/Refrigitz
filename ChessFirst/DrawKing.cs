    ...
    public class DrawKing
    {
            ...
            )
        {
            ...
            for (var i = 0; i < AllDraw.KingMovments; i++)
            {
                ...
                AA.KingThinking[i] = new ThinkingChessFirst(i, 6, CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsChanged, (int)this.Row, (int)this.Column);
