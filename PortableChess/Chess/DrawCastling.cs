    ...
    public class DrawCastling
    {
            ...
            )
        {
            ...
            lock (balancelock)
            {
                ...
                {
                    for (var ii = 0; ii < AllDraw.KingMovments; ii++)
                        CastlingThinking[ii] = new ThinkingRefrigtzChessPortable(ii, 7, CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsChanged, (int)i, (int)j, a, CloneATable(Tab), 8, Ord, TB, Cur, 2, 6);
                }
                else
                {
                    for (var ii = 0; ii < AllDraw.KingMovments; ii++)
            ...
            )
        {
            ...
            for (var i = 0; i < AllDraw.KingMovments; i++)
            {
                ...
                AA.CastlingThinking[i] = new ThinkingRefrigtzChessPortable(i, 6, CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsChanged, (int)this.Row, (int)this.Column);
