...
#pragma warning restore CS0219 // The variable 'NIs' is assigned but its value is never used
        ...
        public void KingThinkingChess(int Kind,ref int[] LoseOcuuredatChiled, ref int WinOcuuredatChiled, int DummyOrder, int DummyCurrentOrder, int[,] TableS, int RowSource, int ColumnSource, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, int RowDestination, int ColumnDestination, bool Castle)
        {
            object O = new object();
            lock (O)
            {
        ...
        //specific determination for thinking main method
        public void MinisterThinkingChess(int Kind,ref int[] LoseOcuuredatChiled, ref int WinOcuuredatChiled, int DummyOrder, int DummyCurrentOrder, int[,] TableS, int RowSource, int ColumnSource, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, int RowDestination, int ColumnDestination, bool Castle)
        {
            object O11 = new object();
            lock (O11)
            {
        ...
        public void CastlesThinkingChess(int Kind,ref int[] LoseOcuuredatChiled, ref int WinOcuuredatChiled, int DummyOrder, int DummyCurrentOrder, int[,] TableS, int RowSource, int ColumnSource, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, int RowDestination, int ColumnDestination, bool Castle
        )
        {
            object O22 = new object();
            lock (O22)
        ...
        //specific determination for thinking main method
        public void HourseThinkingChess(int Kind,ref int[] LoseOcuuredatChiled, ref int WinOcuuredatChiled, int DummyOrder, int DummyCurrentOrder, int[,] TableS, int RowSource, int ColumnSource, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, int RowDestination, int ColumnDestination, bool Castle)
        {
            object OO = new object();
            lock (OO)
            {
        ...
        //specific determination for thinking main method
        //specific determination for thinking main method
        public void ElefantThinkingChess(int Kind,ref int[] LoseOcuuredatChiled, ref int WinOcuuredatChiled, int DummyOrder, int DummyCurrentOrder, int[,] TableS, int RowSource, int ColumnSource, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, int RowDestination, int ColumnDestination, bool Castle)
        {
            object OO = new object();
            lock (OO)
            {
...
#pragma warning restore CS0219 // The variable 'Added' is assigned but its value is never used
        ...
        public void SolderThinkingChess(int Kind,ref int[] LoseOcuuredatChiled, ref int WinOcuuredatChiled, int DummyOrder, int DummyCurrentOrder, int[,] TableS, int RowSource, int ColumnSource, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, int RowDestination, int ColumnDestination, bool Castle)
        {
            object O1 = new object();
            lock (O1)
            {
        ...
        public void ThinkingSoldierbase(int Kind,ref int[] LoseOcuuredatChiled, ref int WinOcuuredatChiled, int ord, int ii, int jj, int i, int j, int DummyOrder, int DummyCurrentOrder, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, bool Castle)
        {
            ...
            lock (O)
            {
                ...
                if (Scop(ii, jj, i, j, 1) && System.Math.Abs(TableS[ii, jj]) == 1 && System.Math.Abs(Kind) == 1)
                {
                    Order = ord;
                    int[] TmpL = LoseOcuuredatChiled; int TmpW = WinOcuuredatChiled;
                    Task newTask = Task.Factory.StartNew(() => SolderThinkingChess(Kind,ref TmpL, ref TmpW, DummyOrder, DummyCurrentOrder, CloneATable(TableS), ii, jj, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, i, j, Castle));
            ...
            lock (O1)
            {
                ...
                lock (O)
                {
                    ...
                    if (Scop(ii, jj, i, j, 2) && System.Math.Abs(TableS[ii, jj]) == 2 && System.Math.Abs(Kind) == 2)
                    {
                        Order = ord;
                        int[] TmpL = LoseOcuuredatChiled; int TmpW = WinOcuuredatChiled;
                        Task newTask = Task.Factory.StartNew(() => ElefantThinkingChess(Kind,ref TmpL, ref TmpW, DummyOrder, DummyCurrentOrder, CloneATable(TableS), ii, jj, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, i, j, Castle));
        ...
        public void ThinkingHourseOne(int Kind,ref int[] LoseOcuuredatChiled, ref int WinOcuuredatChiled, int ord, int ii, int jj, int DummyOrder, int DummyCurrentOrder, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, bool Castle)
        {
            ...
            lock (O1)
            {
                ...
                lock (O)
                {
                    ...
                    {
                        int[] TmpL = LoseOcuuredatChiled; int TmpW = WinOcuuredatChiled;
                        Task newTask = Task.Factory.StartNew(() => HourseThinkingChess(Kind,ref TmpL, ref TmpW, DummyOrder, DummyCurrentOrder, CloneATable(TableS), ii, jj, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, ii + 2, jj + 1, Castle));
        ...
        public void ThinkingHourseFive(int Kind,ref int[] LoseOcuuredatChiled, ref int WinOcuuredatChiled, int ord, int ii, int jj, int DummyOrder, int DummyCurrentOrder, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, bool Castle)
        {
            ...
            lock (O1)
            {
                ...
                lock (O)
                {
                    ...
                    {
                        int[] TmpL = LoseOcuuredatChiled; int TmpW = WinOcuuredatChiled;
                        Task newTask = Task.Factory.StartNew(() => HourseThinkingChess(Kind,ref TmpL, ref TmpW, DummyOrder, DummyCurrentOrder, CloneATable(TableS), ii, jj, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, ii + 1, jj + 2, Castle));
            ...
            lock (O1)
            {
                ...
                Parallel.For(0, 8, i =>
                {
                    ...
                    lock (O)
                    {
                        ...
                        {
                            Order = ord;
                            Task newTask = Task.Factory.StartNew(() => CastlesThinkingChess(Kind,ref TmpL, ref TmpW, DummyOrder, DummyCurrentOrder, CloneATable(TableS), ii, jj, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, i, j, Castle));
            ...
            lock (O1)
            {
                ...
                lock (O)
                {
                    if (Scop(ii, jj, i, j, 5) && System.Math.Abs(TableS[ii, jj]) == 5 && System.Math.Abs(Kind) == 5)
                    {
                        Order = ord;
                        int[] TmpL = LoseOcuuredatChiled; int TmpW = WinOcuuredatChiled;
                        Task newTask = Task.Factory.StartNew(() => MinisterThinkingChess(Kind,ref TmpL, ref TmpW, DummyOrder, DummyCurrentOrder, CloneATable(TableS), ii, jj, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, i, j, Castle));
                ...
                lock (O)
                {
                    ...
                    //for (int i = ii - 1; i < ii + 2; i++)
                    {
                        ...
                        //for (int j = jj - 1; j < jj + 2; j++)
                        {
                            ...
                            {
                                Order = ord;
                                Task newTask = Task.Factory.StartNew(() => KingThinkingChess(Kind,ref TmpL, ref TmpW, DummyOrder, DummyCurrentOrder, CloneATable(TableS), ii, jj, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, i, j, Castle));
